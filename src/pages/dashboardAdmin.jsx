    ...
    return !isAuthenticated ? (
            ...
            >
                <div className="flex items-center justify-center h-screen">
                    <div className="p-8 bg-gray-200/50 border-1 border-gray-700 text-white rounded-lg shadow-lg max-w-sm w-full">
                        <h2 className="mb-4 text-3xl font-bold text-center text-gray-700">Login</h2>
                        <p className="mb-4 text-sm text-center text-gray-500">Silakan masukkan password untuk mengakses halaman ini.</p>
                        <input
                            type="password"
                            className="w-full p-3 mb-4 text-gray-700 rounded-lg border-1 border-gray-500 focus:outline-none focus:ring focus:ring-gray-700"
        ...
        <>
            ...
            >
                ...
                /> */}
                <div className="p-6 bg-gradient-to-l from-gray-900/20 to-gray-800/20 text-white font-sriracha rounded-xl shadow-lg max-w-4xl mx-auto mt-10 z-20 border-1 border-gray-400">
                    <h1 className="text-3xl font-bold text-gray-600 text-center mb-6">{selectedMenu}</h1>
                    {selectedMenu === "Daftar Tamu" && (
                        guests.length > 0 ? (
                            ...
                            <p className="text-center text-gray-200 mt-4">Belum ada tamu yang ditambahkan.</p>
                        ))}
                    ...
                    {selectedMenu === "Reservasi" && (
                        dataReservasi.length > 0 ? (
                            ...
                            <p className="text-center text-gray-200 mt-4">Belum ada data reservasi.</p>
                        ))}
